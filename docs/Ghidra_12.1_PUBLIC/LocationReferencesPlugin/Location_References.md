...
![References To Dialog](images/ReferencesToDialog.png)
...
![Label References Sample](images/LabelReferencesSample.png)
...
![Xref Label References Sample](images/XRefLabelReferencesSample.png)
...
<a name="home"></a>The ![Go Home](../icons/go-home.png) button will
...
<a name="select"></a>The ![Make Selection](../icons/text_align_justify.png) button
...
<a name="highlight"></a>The ![Tag Yellow](../icons/tag_yellow.png)
...
<a name="delete_reference"></a>The ![Delete](../icons/edit-delete.png)
button deletes the selected reference(s).  This will delete the reference from the database.


![Note.Yellow](../shared/note.yellow.png)Not all table rows can be deleted. This is
...
> <a name="make_selection"></a>**Tip:** You can make a
...
> <a name="data_type_discovery"></a>**Note:** By default, finding uses of
