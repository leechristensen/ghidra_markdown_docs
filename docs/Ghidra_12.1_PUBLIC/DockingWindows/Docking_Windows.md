...
corresponding component become the visible component.


Right-clicking on a tab will present a popup menu with the following actions:


- **Rename** - This action allows the user to change the short name shown in the
tab. This action is only available on transient components such as search results.
- **Close Others** - This action closes all other tabs. (and their
corresponding components)
- **Close Tabs to the Left** - This action closes all tabs to the left of the
clicked-on tab. This action is not available for the first tab.
- **Close Tabs to the Right** - This action closes all tabs to the right of the
clicked-on tab. This action is not available for the last tab.
