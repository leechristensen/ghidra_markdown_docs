...
- 'foo.dll', compiled by GCC on January 21st, and
- 'foo_new.dll', compiled by Visual Studio on January 21st.
...
the ![Off](../icons/filter_off.png) icon. This indicates that there
