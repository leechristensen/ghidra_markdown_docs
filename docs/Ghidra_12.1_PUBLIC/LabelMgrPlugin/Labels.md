...
[Namespace Chooser Dialog](#namespace-chooser-dialog). From this chooser dialog,
...
> **Note:** This field is disabled when the namespace
...
![Choose Namespace](images/ChooseNamespace.png)
