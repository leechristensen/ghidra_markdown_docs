...
### Navigating on Program Location Changes


The ![In](../icons/locationIn.gif) button controls whether a symbol is
selected in the Symbol Tree when you click in the Code Browser. While the ![In](../icons/locationIn.gif)  button is selected, if the location from the Code
...
![In](../icons/locationIn.gif) button is
saved when you close the project or exit Ghidra and restored when you reopen the
project.


### Navigating on Symbol Changes


The ![Out](../icons/locationOut.gif) button controls whether a Code Browser
navigation happens when symbol is selected. This action is on by default.
The state of the ![Out](../icons/locationOut.gif) button is saved when you close the
project or exit Ghidra and restored when you reopen the project.
