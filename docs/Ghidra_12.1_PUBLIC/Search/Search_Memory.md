...
This button instantiates a new Memory Search Window using a new choice of program.
...
the set of matches in the table may be reduced based on the values that changed.
...
### Make Selection ![Selection](../icons/text_align_justify.png)
...
[← Previous: Program Search](Searching.md) | [Next: Text →](Search_Program_Text.md)
