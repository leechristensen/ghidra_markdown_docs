...
![Function Comparison Window](images/FunctionComparisonWindow.png)
...
### Cursor Arrow ![Cursor Arrow Flipped](../icons/cursor_arrow_flipped.gif)


The left side margin of each listing can display a cursor arrow ![Cursor Arrow Flipped](../icons/cursor_arrow_flipped.gif) that indicates the code unit with the current cursor
...
1. Select the menu icon ![Menu16](../icons/menu16.gif) on the far right end of
the toolbar.
...
The Function Comparison window has a navigation choice icon with a small triangle ![Menu16](../icons/menu16.gif) to the right of it on the tool
...
- ![Text List Bullets](../icons/text_list_bullets.png) **Both** - Navigates to the
next/previous highlight area whether it is an unmatched code unit block or a difference
block.
- ![Location In](../icons/locationIn.gif) **Unmatched Code Units** -
Navigates between unmatched code unit blocks.
- ![Table Relationship](../icons/table_relationship.png) **Differences** -
...
The Listing View provides an icon (![View Sort Ascending](../icons/view-sort-ascending.png))
on the tool bar to go to the next highlighted area in the listing window.


- Right mouse click and select the ![View Sort Ascending](../icons/view-sort-ascending.png)
**Go To Next Highlighted Area** option, OR select the ![View Sort Ascending](../icons/view-sort-ascending.png) button on the tool bar.
...
The Listing View provides an icon (![View Sort Descending](../icons/view-sort-descending.png))
on the tool bar to go to the previous highlighted area in the listing window.


- Right mouse click and select the ![View Sort Descending](../icons/view-sort-descending.png)
**Go To Previous Highlighted Area** option, OR select the ![View Sort Descending](../icons/view-sort-descending.png) button on the tool bar.
...
The ListingView has an icon (![Binary Data](../icons/binaryData.gif)) on the tool bar
...
pressed inward and will have a ![No Small](../icons/no_small.png) in the upper left
corner.
...
1. Right mouse click and select the ![Binary Data](../icons/binaryData.gif) **Ignore Bytes As Differences** option, OR select the ![Binary Data](../icons/binaryData.gif)
button on the tool bar.
2. A ![No Small](../icons/no_small.png) will be in the upper left corner
...
The Listing View has an icon (![Class](../icons/class.png)) on the tool bar to
...
will have a ![No Small](../icons/no_small.png) in the upper left corner.
...
1. Right mouse click and select the ![Class](../icons/class.png) **Ignore Operand Constants As Differences** option, OR select the ![Class](../icons/class.png) button on the tool bar.
2. A ![No Small](../icons/no_small.png) will be in the upper left corner
...
The Listing View has an icon (![Register Group](../icons/registerGroup.png)) on the tool
...
look as though it is pressed inward and will have a ![No Small](../icons/no_small.png) in the upper left corner.
...
1. Right mouse click and select the ![Register Group](../icons/registerGroup.png)
**Ignore Operand Registers As Differences** option, OR select the ![Register Group](../icons/registerGroup.png) button on the tool bar.
2. A ![No Small](../icons/no_small.png) will be in the upper left corner
...
![Listing Code Comparison Options](images/ListingCodeComparisonOptions.png)
...
### Add To Existing Comparison ![Add To Comparison Icon](images/AddToComparisonIcon.png)
...
![Add Functions Panel](images/AddFunctionsPanel.png)
...
### Remove Function From Comparison ![Remove From Comparison Icon](images/RemoveFromComparisonIcon.png)
...
### Go To Next Function ![Nav Next Icon](images/NavNextIcon.png)


Navigates to the next available function in the selection pulldown


### Go To Previous Function ![Nav Previous Icon](images/NavPreviousIcon.png)
...
a popup. You can turn the hover popup windows off using the ![Hover On](../icons/hoverOn.gif) mouse hover button in the toolbar.


1. Selecting the ![Hover On](../icons/hoverOn.gif) button in the toolbar will turn
mouse hover popups off and the icon will switch to a ![Hover Off](../icons/hoverOff.gif).
2. Selecting the ![Hover Off](../icons/hoverOff.gif) button in the toolbar will
turn mouse hover popups back on and the icon will switch to a ![Hover On](../icons/hoverOn.gif).


#### Synchronize Scrolling of Dual View


If the ![Lock](../icons/lock.gif) button is showing in the toolbar then
...
When the ![Unlock](../icons/unlock.gif) button is showing in the toolbar the
left and right sides of the dual listing or dual decompiler will scroll independent
of the other side.


1. Selecting the ![Lock](../icons/lock.gif) button in the toolbar will turn
synchronized scrolling of the dual views off and the icon will switch to a
![Unlock](../icons/unlock.gif).
2. Selecting the ![Unlock](../icons/unlock.gif) button in the toolbar will
