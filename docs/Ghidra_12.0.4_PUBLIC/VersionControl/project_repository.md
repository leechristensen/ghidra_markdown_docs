...
in your shared project. It can also happen if your checkout of the file is [terminated](#view-checkouts).  The [file icon](../FrontEndPlugin/Ghidra_Front_end.md#file-icons) in the Ghidra
...
becomes [hijacked](../FrontEndPlugin/Ghidra_Front_end.md#file-icons).
