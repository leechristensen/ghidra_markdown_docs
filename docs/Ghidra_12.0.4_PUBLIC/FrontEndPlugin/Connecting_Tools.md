...
Tool connections are directional. You can connect two Tools A and B in a *single direction* such that Tool A generates an event consumed by Tool B; however, Tool A will not
...
You manually connect tools by selecting the **Tools** → **Connect Tools...** option from the [Ghidra Project
Window](Ghidra_Front_end.md).


![Connect Tools](images/ConnectTools.png)
