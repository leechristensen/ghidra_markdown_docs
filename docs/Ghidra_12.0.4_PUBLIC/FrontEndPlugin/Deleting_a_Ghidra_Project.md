...
Project** from the menu. The *Delete a Ghidra Project* dialog will appear.


![](images/DeleteProject.png)


1. Select the project, i.e. project_name.gpr, to delete or enter its name in the *File
name* field. The project cannot be your active project.
...
![](images/ConfirmDeleteProject.png)
