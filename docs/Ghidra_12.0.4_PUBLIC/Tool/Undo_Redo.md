...
- To *undo* an edit operation, select **Edit → Undo** from the main menu or press the [Undo]
button on the tool bar.
- To *redo* an edit operation, select **Edit → Redo** from the main menu or press the [Redo]
button on the tool bar.
