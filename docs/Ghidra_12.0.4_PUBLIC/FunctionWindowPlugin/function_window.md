...
The Functions window provides a list of functions defined in the currently open program.
...
The Functions window has an icon (![Make Selection](../icons/text_align_justify.png))
...
existing comparison window itself.


To create a new comparison:


1. Select the functions you want to compare from the table in the Functions window.
You must select one or more rows in the table.
2. Right mouse click and select the **Compare Selected Functions** option,
OR click the create-comparison icon on the tool bar.


The resulting [Function Comparison](../FunctionComparison/FunctionComparison.md)
