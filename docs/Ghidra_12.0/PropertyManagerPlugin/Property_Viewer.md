...
the [navigation
margin](../CodeBrowserPlugin/CodeBrowser.md#cbnavigationmargin) in [Code Browser](../CodeBrowserPlugin/CodeBrowser.md) shows a
...
property is defined, as shown in the image below. The [left margin](../CodeBrowserPlugin/CodeBrowser.md#cbmarkermargin) on the shows
marker for the "Source File" property; the [right margin](../CodeBrowserPlugin/CodeBrowser.md#cbnavigationmargin) shows the
...
- [Marker Margin](../CodeBrowserPlugin/CodeBrowser.md#cbmarkermargin)
