...
Matches](#implied-matches) for the selected match in the [Matches
Table](VT_Matches_Table.md#matches-table). The implied matches are generated by pairing up the **outgoing** references
...
session that has the same [association](../Version_Tracking_Intro.md#intro-associations)
