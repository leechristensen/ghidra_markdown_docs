...
programs that the tools had open are opened. The last active [workspace](Ghidra_Front_end.md#workspace) from this project now shows up as the active
workspace. Other [viewed projects](Ghidra_Front_end.md#readonlyprojectdatapanel)
are restored.
...
attempts to [connect
to the Ghidra Server](../VersionControl/project_repository.md#connecttoserver). You may have to enter a password, depending on the type of
